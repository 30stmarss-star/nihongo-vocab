 ...
 *  - 뜻·읽기·예문 후리가나는 가려져 있고, 그룹을 꾹 누르면 그 그룹 전체가 한꺼번에 드러난다.
 *    (손을 떼면 다시 가려짐 — 한자→읽기·뜻 능동 회상)
 */
  ...
  return (
    <div className="space-y-3">
      <p className="text-xs text-neutral-500">
        ...
        그룹을 <b className="text-neutral-300">꾹 누르면</b> 그 묶음의 뜻·읽기가 한꺼번에 드러나요.
      </p>
...
function GroupCard({ g }: { g: ConfusableGroup }) {
  const [revealed, setRevealed] = useState(false);

  return (
    <section className="overflow-hidden rounded-2xl border border-white/10 bg-neutral-950/60">
